...
var interval;
var images = {
  pinkDot: "https://res.cloudinary.com/davd4ynha/image/upload/v1561785656/pinkDot.png",
  blueDot: "https://res.cloudinary.com/davd4ynha/image/upload/v1561785606/blueDot.svg",
  ironHack: "https://res.cloudinary.com/davd4ynha/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1561788405/coin.jpg",
  rabbit: "https://res.cloudinary.com/davd4ynha/image/upload/v1561785661/rabbit.png",
  turtle: "https://res.cloudinary.com/davd4ynha/image/upload/v1561785666/tortuga.png"
};
...
class Maze {
  constructor() {
    ...
    this.music.src = "https://res.cloudinary.com/davd4ynha/video/upload/v1561786336/Jackson5.mp3";
  }
  draw() {
    mazeReader();
  }
...
class Prize {
  constructor(x, y, image) {
    ...
    this.touch.src = "https://res.cloudinary.com/davd4ynha/video/upload/v1561786345/JSnoTeEspera.m4a";
  }
  draw() {
    context.drawImage(this.image, this.x, this.y, this.width, this.height);
  }
